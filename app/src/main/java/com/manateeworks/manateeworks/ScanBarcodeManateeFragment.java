...
//            initCamera();
    ...
    private void initView(View v) {
        ...
        zoomButton = (ImageButton) v.findViewById(R.id.zoomButton);
        buttonFlash = (ImageButton) v.findViewById(R.id.flashButton);
    }
    ...
    public void initOnCreate() {
        ...
        int registerResult = BarcodeScanner.MWBregisterSDK("SDK Key", getActivity());
        ...
        if (PDF_OPTIMIZED) {
            ...
            //BarcodeScanner.MWBsetDirection(BarcodeScanner.MWB_SCANDIRECTION_OMNI);
            ...
            if(status == BarcodeScanner.MWB_RT_OK){
                BarcodeScanner.MWBsetActiveSubcodes(BarcodeScanner.MWB_CODE_MASK_EANUPC,
                        BarcodeScanner.MWB_SUBC_MASK_EANUPC_EAN_13
                                ...
                                | BarcodeScanner.MWB_SUBC_MASK_EANUPC_UPC_E1);
            }
...
//        BarcodeScanner.MWBsetMinLength(BarcodeScanner.MWB_CODE_MASK_11, 5);
        BarcodeScanner.MWBsetMinLength(BarcodeScanner.MWB_CODE_MASK_EANUPC, 13);
...
//        });
    ...
    private void initSurfaceView() {
        ...
        if (OVERLAY_MODE == OverlayMode.OM_MWOVERLAY) {
            MWOverlay.addOverlay(getActivity(), surfaceView);
        }
        ...
        if (!getActivity().isFinishing()) {
            if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            .setPositiveButton("OK",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.CAMERA}, 12322);
                                        }
                                    })
                ...
                try {
                    ...
                    boolean isOrientation = getActivity().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
                    Log.d("isOrientation %s", String.valueOf(isOrientation));
                    CameraManager.get().openDriver(surfaceHolder, isOrientation);
    ...
    public void handleDecode(BarcodeScanner.MWResult result) {
        ...
        if (bcType >= 0) {
            if (getActivity().getIntent().hasExtra("position")) {
                ...
                returnIntent.putExtra("position", getActivity().getIntent().getExtras().getInt("position"));
