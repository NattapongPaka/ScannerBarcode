...
//        System.out.println("==="+ScreenUtil.getInstantce().getScreenWidth());
//
//        int _padding = (ScreenUtil.getInstantce().getScreenWidth() - width) / 2;
//        int custom_width = width + _padding;
//
